...
let stringOrBoolArray : (boolean | string)[] = [false, "string", true, 'another string']

let array: any[] = [1, false, {}, []] // Functions like a normal JS array
...
let genericArray : Array<number> = [1,2,3,4,5] // this is exactly the same as our numArray defined above
